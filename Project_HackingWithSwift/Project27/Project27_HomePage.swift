...
class Project27_HomePage: UIViewController {

    // MARK: - Properties
    var currentDrawType = 0
    
    // MARK: - IBOutlet
    @IBOutlet weak var Project27_imageView: UIImageView!
    
    // MARK: - LifeCycle
    override func viewDidLoad() {
        super.viewDidLoad()
        
        title = "Project27_CoreGraphics"
